...
def smart_concat(subtype):
    import csv

    out = 'data/%s_all_hi_strains.tsv'%(subtype)
    f1, f2, f3 = 'data/%s_cdc_hi_cell_strains.tsv'%(subtype), 'data/%s_cdc_hi_egg_strains.tsv'%(subtype), 'data/%s_crick_hi_strains.tsv'%(subtype)

    d = {}
    for strain_file in [f1, f2, f3]:
